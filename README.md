<!--
---
name: Pytjon Azure Functions using OpenAI extension for OpenAI retrieval augmented generation with Azure AI Search and exposed as an MCP tool
description: This repository contains a Python Azure Function using OpenAI trigger and bindings extension to highlight OpenAI retrieval augmented generation with Azure AI Search. The sample exposes the imported data as an MCP tool for agents to use.
page_type: sample
products:
- azure-functions
- azure
- entra-id
urlFragment: azure-functions-openai-aisearch-mcp-python
languages:
- python
- bicep
- azdeveloper
